...
import { UsersIcon, TargetIcon, TrendingUpIcon, DollarSignIcon, PlusIcon, Share2Icon, StarIcon, SmileIcon, ThumbsUpIcon, MehIcon, FrownIcon, LightbulbIcon, CalendarIcon } from '@/constants';
...
const ClientReports: React.FC<ClientReportsProps> = (props) => {
    ...
    return (
        <div className="space-y-6">
            <PageHeader
                title="Analisis & Testimoni"
                subtitle="Pantau performa bisnis, tingkat konversi Calon Pengantin, dan kepuasan Pengantin dari setiap Acara Pernikahan."
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-4 mt-6 sm:mt-0">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto order-1 sm:order-none">
                        <button 
                            ...
                            className="flex-1 sm:flex-none px-4 py-2 rounded-xl bg-white/10 text-white border border-white/20 hover:bg-white/20 transition-all text-xs font-bold inline-flex items-center justify-center gap-2"
                        >
                            <Share2Icon className="w-4 h-4 text-white/70" />
